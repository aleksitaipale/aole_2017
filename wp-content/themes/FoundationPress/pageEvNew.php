...
<div class="main-wrap" role="main">
	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		foreach ($events as $event){
			...
			$post_info->the_permalink = get_permalink($post_id);

			$post_info->custom_fields = CFS()->get(false, $post_id); //Add all the fields from CFS to the post info object
				...
				<li>
					...
					foreach ($future_events as &$post) {
						...
						<span><?php 
							...
							?></span>
							<span><?php echo $post->custom_fields["event_type"]?></span>
